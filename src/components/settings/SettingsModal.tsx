    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-md animate-fadeIn">
      ...
      >
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6">
          ...
          {activeTab === 'audio' && (
            <div className="space-y-6">
              {/* DSP Sound Processing & Enhancement Engines */}
              <div className="p-4 rounded-lg bg-slate-900/60 border border-slate-800 space-y-4">
                <h4 className="text-sm font-semibold text-cyan-400 font-mono flex items-center gap-2">
                  <Sliders size={14} />
                  Motores DSP de Mejora Acústica Hi-Fi
                </h4>

                {/* LG XDSS Plus */}
                <div className="flex items-start justify-between gap-4 p-3 rounded-lg bg-slate-950/80 border border-slate-800">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <span className="text-xs font-bold text-amber-400 font-mono">⚡ LG XDSS Plus</span>
                      <span className="text-[10px] px-1.5 py-0.2 bg-amber-950/60 text-amber-300 rounded border border-amber-800/60 font-mono">
                        Dynamic Power
                      </span>
                    </div>
                    <p className="text-[11px] text-slate-400 leading-relaxed">
                      <strong>Extreme Dynamic Sound System Plus:</strong> Realce dinámico de graves profundos (+14dB) y excitador de armónicos en agudos (+12dB) con saturación analógica para pegada contundente y presencia vibrante.
                    </p>
                  </div>
                  <input
                    type="checkbox"
                    ...
                    onChange={(e) =>
                      setAudioSettings({
                        isXdssEnabled: e.target.checked,
                        isXtsProEnabled: e.target.checked ? false : audioSettings.isXtsProEnabled,
                      })
                    }
                    className="accent-amber-500 w-4 h-4 cursor-pointer mt-1"
                  />
                </div>
                ...
                <div className="flex items-start justify-between gap-4 p-3 rounded-lg bg-slate-950/80 border border-slate-800">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <span className="text-xs font-bold text-cyan-300 font-mono">✨ LG XTS Pro</span>
                      <span className="text-[10px] px-1.5 py-0.2 bg-cyan-950/60 text-cyan-300 rounded border border-cyan-800/60 font-mono">
                        Studio Master
                      </span>
                    </div>
                    <p className="text-[11px] text-slate-400 leading-relaxed">
                      <strong>Excellent True Sound Pro:</strong> Procesador activo anti-distorsión de respuesta plana con compresión suave multibanda simétrica. Mantiene equilibrio y transparencia de audio fiel a la grabación original.
                    </p>
                  </div>
                  <input
                    type="checkbox"
                    checked={audioSettings.isXtsProEnabled}
                    onChange={(e) =>
                      setAudioSettings({
                        isXtsProEnabled: e.target.checked,
                        isXdssEnabled: e.target.checked ? false : audioSettings.isXdssEnabled,
                      })
                    }
                    className="accent-cyan-400 w-4 h-4 cursor-pointer mt-1"
                  />
                </div>
                ...
                <div className="flex items-start justify-between gap-4 p-3 rounded-lg bg-slate-950/80 border border-slate-800">
                  <div className="space-y-1">
                    <span className="text-xs font-bold text-orange-400 font-mono">🔥 Emulador a Válvulas (Tube Warmth)</span>
                    <p className="text-[11px] text-slate-400 leading-relaxed">
                      Generación de armónicos pares simétricos para conferir el timbre cálido, sedoso y musical de los preamplificadores de válvulas de vacío clásicos.
                    </p>
                  </div>
                  <input
                    type="checkbox"
                    ...
                    onChange={(e) =>
                      setAudioSettings({ tubeWarmth: e.target.checked })
                    }
